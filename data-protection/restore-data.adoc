...
Durch das Wiederherstellen einer Konsistenzgruppe werden die Daten in allen Speichereinheiten der Konsistenzgruppe durch die Daten eines Snapshots ersetzt. Änderungen, die nach der Erstellung des Snapshots an den Speichereinheiten vorgenommen wurden, werden nicht wiederhergestellt.
