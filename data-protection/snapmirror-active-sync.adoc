...
---
= SnapMirror Active Sync-Einrichtungsworkflow für ASA r2 Systeme
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
SnapLock Enterprise- und Compliance-Modi werden mit SnapMirror Active Sync auf ASA r2 Systemen nicht unterstützt.
