...
* Ab ONTAP 9.19.1 RC unterstützt der autonome Ransomware-Schutz mit künstlicher Intelligenz (ARP/AI) primäre Lese-/Schreibspeichereinheiten in SnapMirror Aktiv/Aktiv-SAN-Beziehungen auf ASA r2-Systemen. ARP/AI läuft auf den aktiven primären Speichereinheiten, erstellt ausschließlich primäre ARP-Snapshots und bietet maschinelles Lernen zur Ransomware-Erkennung für diese Speichereinheiten. Informationen zu den Schritten zur Aktivierung von ARP/AI finden Sie unter link:../secure-data/enable-anti-ransomware-protection.html["Autonomen Ransomware-Schutz mit KI aktivieren"].
