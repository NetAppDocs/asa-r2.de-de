...
Ab ONTAP 9.16.1 kann der System Manager verwendet werden, um hierarchische Konsistenzgruppen auf dem ASA r2 System zu erstellen. In einer hierarchischen Struktur sind eine oder mehrere Konsistenzgruppen als untergeordnete Gruppen einer übergeordneten Konsistenzgruppe konfiguriert.
