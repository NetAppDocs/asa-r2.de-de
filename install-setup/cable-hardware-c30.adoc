...
summary: Verbinden Sie das ASA C30-Speichersystem mit Ihrem Netzwerk und Ihren Storage-Shelfs, um die Clusterkommunikation, den Managementzugriff und die SAN-Host-Konnektivität zu ermöglichen. 
---
= Verkabeln Sie die Hardware für das ASA C30-Speichersystem
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verbinden Sie das ASA C30-Speichersystem mit Ihrem Netzwerk und den Storage Shelves, um die Clusterkommunikation, den Managementzugriff und die SAN-Host-Konnektivität zu ermöglichen. Diese Vorgehensweise umfasst die Verkabelung für Cluster-/HA-Interconnect, Managementnetzwerk, Hostnetzwerk und Storage Shelf-Verbindungen.
...
Verbinden Sie an jedem Controller die Kabelanschlüsse e2a, e2b, e2c und e2d mit den Ethernet-Host-Netzwerk-Switches.
...
Verbinden Sie an jedem Controller die Kabelanschlüsse 2a, 2b, 2c und 2d mit den FC-Host-Netzwerk-Switches.
