...
summary: Verbinden Sie das ASA A20, ASA A30 oder ASA A50 Speichersystem mit Ihrem Netzwerk und Ihren Speicherschränken, um die Clusterkommunikation, den Managementzugriff und die SAN-Host-Konnektivität zu ermöglichen. 
---
= Verkabeln Sie die Hardware für die ASA A20, ASA A30 und ASA A50 Speichersysteme
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verbinden Sie das ASA A20-, ASA A30- oder ASA A50-Speichersystem mit Ihrem Netzwerk und den Storage Shelves, um die Clusterkommunikation, den Managementzugriff und die SAN-Host-Konnektivität zu ermöglichen. Diese Vorgehensweise umfasst die Verkabelung für Cluster-/HA-Interconnect, Managementnetzwerk, Hostnetzwerk und Storage Shelf-Verbindungen.
...
Verbinden Sie die Cluster/HA-Verbindungsports an den E/A-Modulen in den Steckplätzen 2 und 4.
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_2card_cabling_ieops-2011.svg[Schaltplan für die Clusterverkabelung ohne Switches unter Verwendung von zwei 100-GbE-I/O-Modulen]
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_1card_cabling_ieops-1925.svg[Verkabelungsdiagramm für Cluster ohne Switches mit einem 100-GbE-I/O-Modul]
...
+
image:../media/oie_cable_sfp_gbe_copper.png["GbE SFP Kupferanschluss, Breite=100px"]

+
image::../media/drw_isi_a20_switchless_2p_25gbe_cabling_ieops-2018.svg[ASA A20 Cluster ohne Switches Verkabelungsdiagramm mit einem 25-GbE-I/O-Modul]
...
.ASA A30 oder ASA A50 mit zwei 40/100-GbE-I/O-Modulen mit 2 Ports
Verbinden Sie die Cluster/HA-Verbindungsports an den E/A-Modulen in den Steckplätzen 2 und 4 mit den Cluster-Netzwerk-Switches.
...
+
image::../media/drw_isi_a30-50_switched_2p_100gbe_2card_cabling_ieops-2013.svg[Schaltplan für die Clusterverkabelung mit zwei 100-GbE-I/O-Modulen]
...
+
image::../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg[ASA A20 Verkabelungsdiagramm für ein Switched Cluster mit einem 25-GbE-I/O-Modul]
...
.ASA A30 oder ASA A50 mit zwei 40/100-GbE-I/O-Modulen mit 2 Ports
Verwenden Sie die Ports e2b und e4b an jedem Controller, um eine Verbindung zu den Ethernet-Host-Netzwerk-Switches herzustellen.
...
image::../media/oie_cable_sfp_gbe_copper.png[40/100-GbE-Kabel]

image::../media/drw_isi_a30-50_host_2p_40-100gbe_2card_cabling_ieops-2014.svg[Kabel zu 40/100-GbE-Ethernet-Host-Netzwerk-Switches]

.ASA A20, A30 oder A50 mit einem 4-Port 10/25 GbE I/O-Modul
Verwenden Sie alle vier Ports des E/A-Moduls in Steckplatz 2, um eine Verbindung zu den Ethernet-Host-Netzwerk-Switches herzustellen.

Verbinden Sie an jedem Controller die Ports e2a, e2b, e2c und e2d mit den Ethernet-Host-Netzwerk-Switches.

*10/25-GbE-Kabel*

image:../media/oie_cable_sfp_gbe_copper.png["GbE SFP Kupferanschluss, Breite=100px"]

image::../media/drw_isi_a30-50_host_2p_40-100gbe_1card_cabling_ieops-1923.svg[Kabel zu 10/25-GbE-Ethernet-Host-Netzwerk-Switches]
...
.ASA A20, A30 oder A50 mit einem 4-Port 64 Gb/s FC I/O-Modul
Nutzen Sie alle vier Ports des FC-E/A-Moduls in Steckplatz 2, um eine Verbindung zu den FC-Host-Netzwerk-Switches herzustellen.

Verbinden Sie an jedem Controller die Ports 2a, 2b, 2c und 2d mit den FC-Host-Netzwerk-Switches.

*64 Gbit/s FC-Kabel*

image:../media/oie_cable_sfp_gbe_copper.png["64 Gbit/s FC-Kabel, width=100px"]

image::../media/drw_isi_a30-50_4p_64gb_fc_1card_cabling_ieops-1924.svg[Kabel zu 64-Gb/s-FC-Host-Netzwerk-Switches]
...
Verbinden Sie jeden Controller mit jedem NSM-Modul auf dem NS224-Regal mithilfe der Speicherkabel, die mit Ihrem Speichersystem geliefert wurden.
