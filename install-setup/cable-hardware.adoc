...
.Über diese Aufgabe
* Diese Verfahren zeigen gängige Konfigurationen. Die jeweilige Verkabelung hängt von den für das Speichersystem bestellten Komponenten ab. Umfassende Konfigurationsdetails finden Sie unter link:https://hwu.netapp.com["NetApp Hardware Universe"^].
...
.. Verbinden Sie den Controller A-Port e2a mit dem Cluster-Netzwerk-Switch B.
...
.ASA A30 und ASA A50: Zwei 40/100-GbE-I/O-Module mit 2 Ports
[%collapsible]
=====
...
=====
.ASA A20, A30 und A50: Ein 10/25-GbE-I/O-Modul mit 4 Ports
[%collapsible]
=====
...
.ASA A20, A30 und A50: Ein 64-Gbit/s-FC-I/O-Modul mit 4 Ports
[%collapsible]
=====
...
.A20, A30 UND A50
--
Schließen Sie jeden Controller mithilfe der Storage-Kabel des Storage-Systems an sein entsprechendes NSM100B-Modul im NS224-Shelf an. Folgende Kabeltypen sind unter Umständen möglich:
