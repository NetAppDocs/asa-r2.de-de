...
.. Stellen Sie sicher, dass die Führungsstifte am Schrank oder Telco-Rack sicher in die Führungsschlitze des Speichersystems passen.
...
. Wenn Ihr ASA r2-System mit einem Kabelverwaltungsgerät geliefert wurde, schließen Sie es an der Rückseite des Speichersystems an.
+
image::../media/drw_affa1k_install_cable_mgmt_ieops-1697.svg[Installieren Sie das Kabelverwaltungsgerät]

. Installieren und befestigen Sie das Lagerregal:
+
