...
summary: Verbinden Sie das ASA A1K-Speichersystem mit Ihrem Netzwerk und Ihren Storage-Shelfs, um die Clusterkommunikation, den Managementzugriff und die SAN-Host-Konnektivität zu ermöglichen. 
---
= Verkabeln Sie die Hardware für das ASA A1K-Speichersystem
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verbinden Sie das ASA A1K-Speichersystem mit Ihrem Netzwerk und den Storage Shelves, um die Clusterkommunikation, den Managementzugriff und die SAN-Host-Konnektivität zu ermöglichen. Diese Vorgehensweise umfasst die Verkabelung für Cluster-/HA-Interconnect, Managementnetzwerk, Hostnetzwerk und Storage Shelf-Verbindungen.
...
* Die I/O-Steckplätze der ASA A1K sind von 1 bis 11 nummeriert.
+
...
+
image::../media/drw_a1k_network_cabling1_ieops-1649.svg[Kabel zu 100-GbE-Ethernet-Netzwerk]
...
image::../media/oie_cable_sfp_gbe_copper.svg[10/25-GbE-Ethernetkabel]

image::../media/drw_a1k_network_cabling2_ieops-1650.svg[Kabelverbindung zu 10/25-GbE-Ethernet-Netzwerk]
...
Die ASA A1K-Speichersysteme unterstützen NS224-Einschübe mit entweder dem NSM100- oder dem NSM100B-Modul. Die wichtigsten Unterschiede zwischen den Modulen sind:
...
.. Verbinden Sie Port e11b mit NSM B Port e0b.
+
...
.. Verbinden Sie Port e10b mit Port e0b von Shelf 1 NSM B.
+
