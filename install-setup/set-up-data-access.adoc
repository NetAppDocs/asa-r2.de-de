...
ASA r2-Speichereinheiten sind standardmäßig Thin Provisioning-fähig.  Bei der Migration Ihrer VM-Workload sollten auch virtuelle Festplatten (VMDKs) Thin Provisioning verwenden.
...
* Erfahren Sie mehr überlink:https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_setup_Broadcom_VMware_ESXi_iSCSI_MPIO_with_ONTAP_SAN_ASA["Wie richtet man Broadcom VMware ESXi iSCSI MPIO mit ONTAP SAN ASA -Speichersystemen ein?"^] .
...
Ab ONTAP 9.19.1 unterstützt FLI das iSCSI-Protokoll für die Backend-Konnektivität.

* Erfahren Sie mehr über den Link: https://docs.netapp.com/us-en/ontap-fli/get-started/learn-about-data-migration.html[ONTAP FLI migrations^].
