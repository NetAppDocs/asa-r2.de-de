...
[role="lead"]
Ab ONTAP 9.18.1 können Sie eine Storage Virtual Machine (VM) unterbrechungsfrei von einem beliebigen Standard ASA Cluster zu einem beliebigen ASA r2 Cluster migrieren. Die Migration von einem Standard ASA Cluster zu einem ASA r2 Cluster ermöglicht die Nutzung der vereinfachten und optimierten Architektur von ASA r2 Systemen für reine SAN-Umgebungen.
