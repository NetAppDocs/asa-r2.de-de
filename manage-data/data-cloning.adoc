...
[role="lead"]
Durch das Klonen von Daten werden Kopien von Speichereinheiten und Konsistenzgruppen auf Ihrem ASA r2 System erstellt. Die Kopien können für Anwendungsentwicklung, Tests, Backups, Datenmigration und andere administrative Funktionen genutzt werden.
...
.. Geben Sie einen Namen für den neuen Host ein; wählen Sie anschließend *FC* oder *iSCSI* aus.
...
.Schritte
. Wählen Sie in System Manager *Schutz > Consistency Groups* aus.
. Fahren Sie mit dem Mauszeiger über die Konsistenzgruppe-Kopie, die Sie aufteilen möchten.
