...
[role="lead"]
ONTAP System Manager ermöglicht die Überwachung der Gesamtleistung Ihres Clusters und bestimmter Speichereinheiten, einschließlich Latenz, IOPS und Durchsatz, über Zeiträume von einer Stunde bis zu einem Jahr.
...
Anhand von Leistungskennzahlen der Speichereinheiten lässt sich der Einfluss spezifischer Anwendungen auf Latenz, IOPS und Durchsatz ermitteln.
...
.Was kommt als Nächstes?
Anhand der Leistungskennzahlen Ihrer Speichereinheiten lässt sich analysieren, ob die den Speichereinheiten zugewiesenen QoS-Richtlinien angepasst werden sollten, um die Latenz zu verringern und IOPS sowie Durchsatz zu maximieren.
