...
[role="lead"]
ONTAP System Manager ermöglicht die Anzeige einer Liste von Fehlern oder Warnmeldungen, empfohlenen Korrekturmaßnahmen, Systemüberwachungsprotokollen sowie aktiven, abgeschlossenen oder fehlgeschlagenen Aufträgen.
...
.Ergebnis
Die hinzugefügte E-Mail-Adresse erhält die angegebenen E-Mail-Benachrichtigungen für Cluster-Ereignisse und Audit-Logs.
