...
Die Mindestanzahl an Laufwerken, die in einem einzigen Vorgang hinzugefügt werden sollte, beträgt drei. Das Hinzufügen eines Einzellaufwerks kann die Leistung beeinträchtigen.
...
+
** Leuchtet die LED dauerhaft, ist das Laufwerk mit Strom versorgt.
