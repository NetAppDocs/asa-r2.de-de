...
[role="lead"]
Um mit Ihrem ASA r2 System zu starten, werden die Hardwarekomponenten installiert, der Cluster eingerichtet, der Datenzugriff von Ihren SAN-Clients auf das Speichersystem konfiguriert und der Speicher bereitgestellt.
