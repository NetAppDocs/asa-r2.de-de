...
| Speicher-VMs pro Cluster | Die maximale Anzahl unterstützter virtueller Speichermaschinen (VMs) pro HA-Paar wurde von 32 auf 256 erhöht. | ONTAP 9.18.1 


| SnapMirror aktive Synchronisierung | Die Unterstützung für SnapMirror active sync wurde von Zwei-Knoten-Clustern auf Vier-Knoten-Cluster erweitert. | ONTAP 9.18.1 
