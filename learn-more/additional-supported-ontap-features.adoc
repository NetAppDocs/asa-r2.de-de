...
link:https://docs.netapp.com/us-en/ontap/networking/configure_tls_hardware_offload.html["Lernen Sie, die Hardware-Offload-Funktion für TLS zu konfigurieren."^].
