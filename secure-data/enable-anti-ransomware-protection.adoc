...
ARP verbessert die Cyber-Resilienz durch den Einsatz eines Machine-Learning-Modells zur Anti-Ransomware-Analyse, das sich ständig weiterentwickelnde Formen von Ransomware für SAN-Umgebungen erkennt. Das Machine-Learning-Modell von ARP wird anhand eines großen Datensatzes von Dateien sowohl vor als auch nach einem simulierten Ransomware-Angriff vortrainiert. Dieses ressourcenintensive Training findet außerhalb von ONTAP statt, und das daraus resultierende vortrainierte Modell ist mit ONTAP enthalten. Dieses Modell ist nicht zugänglich oder veränderbar. ARP/AI ist unmittelbar nach der Aktivierung aktiv; es gibt keine link:https://docs.netapp.com/us-en/ontap/anti-ransomware/index.html#learning-and-active-modes["Lernphase"^].
