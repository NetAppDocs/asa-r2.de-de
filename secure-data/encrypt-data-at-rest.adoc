...
Wenn Sie vom Onboard Key Manager zu einem externen Key Manager wechseln müssen oder umgekehrt, siehe link:https://docs.netapp.com/us-en/ontap/encryption-at-rest/migrate-keys-between-key-managers.html["Migrieren Sie die ONTAP Datenverschlüsselung zwischen Schlüsselmanagern"^].
